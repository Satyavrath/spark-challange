package edu.nwmissouri.injamuri;
...
public final class App {
    private static void sortWord(String fileName) {
    ...
    // JavaPairRDD<Integer, String> reverseOutput =  output.sortByKey(Comparator.reverseOrder());
